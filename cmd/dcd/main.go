// Command dcd reports dead code in Go, JavaScript/TypeScript, CSS, and Python.
package main
...
const usage = `dcd — dead code detector for Go, JavaScript/TypeScript, CSS, and Python
...
func run(args []string) int {
	...
	lang := fs.String("lang", "", "comma-separated languages: go,js,css,py (default: auto-detect)")
	...
	fs.Var(&entries, "entry", "JavaScript/Python entry file (repeatable)")
